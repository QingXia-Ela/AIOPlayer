import React, { FunctionComponent, CSSProperties, useImperativeHandle } from "react";
...
const OuterThumb = React.forwardRef<OuterThumbMethods, OuterThumbProps>(({ marginBarHeightLimit = 0, ScrollbarDegNum = 0.5, ...props }, _ref) => {
  const [
    sp,
    setSP
  ] = React.useState<ScrollClipPathProps>({
    lt: -1,
    rt: 1,
    lb: -1,
    rb: 1,
